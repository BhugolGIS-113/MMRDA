...
class PAP(Baseclass):
    ...
    legalDocuments = models.FileField(
        upload_to='PAP/PAP_legalDocuments/', blank=True, null=True)
...
class ConstructionSiteDetails(Baseclass):
    user = models.ForeignKey(User, related_name='constructionsite_user',on_delete=models.CASCADE , blank=True, null=True)
    ...
    isDemarkationOfPathways=models.BooleanField(blank=True)
    demarkationOfPathwaysCondition=models.CharField(max_length=255,blank=True, null=True)
    demarkationOfPathwaysPhotographs=models.ImageField(upload_to='constructionSite/demarkingPathways_photographs/',  blank=True, null=True)
    demarkationOfPathwaysRemark=models.TextField(max_length=255, blank=True, null=True)

    isSignagesLabeling=models.BooleanField(blank=True)
    signagesLabelingCondition=models.CharField(max_length=255, blank=True, null=True)
    signagesLabelingPhotographs=models.ImageField(upload_to='constructionSite/signagesLabeling_Photographs/',  blank=True, null=True)
    signagesLabelingRemarks=models.TextField(max_length=255,  blank=True, null=True)

    isRegularHealthCheckup=models.BooleanField(blank=True)
    regularHealthCheckupCondition=models.CharField(max_length=255, blank=True, null=True)
    regularHealthCheckupPhotographs=models.ImageField(upload_to='constructionSite/RegularHealthCheckup_Photographs/', blank=True, null=True)
    regularHealthCheckupRemarks=models.TextField(max_length=255,  blank=True, null=True)

    isAvailabilityOfDoctor=models.BooleanField(blank=True)
    availabilityOfDoctorCondition=models.CharField(max_length=255, blank=True, null=True)
    availabilityOfDoctorPhotographs=models.ImageField(upload_to='constructionSite/AvailabilityOfDoctor_photographs/',  blank=True, null=True)
    availabilityOfDoctorRemarks=models.TextField(max_length=255,  blank=True, null=True)

    isFirstAidKit=models.BooleanField(blank=True)
    firstAidKitCondition=models.CharField(max_length=255, blank=True, null=True)
    firstAidKitPhotographs=models.ImageField(upload_to='constructionSite/FirstAidKit_photographs/', blank=True, null=True)
    firstAidKitRemarks=models.TextField(max_length=255,  blank=True, null=True)

    isDrinkingWater=models.BooleanField(blank=True)
    drinkingWaterCondition=models.CharField(max_length=255, blank=True,  null=True)
    drinkingWaterPhotographs=models.ImageField(upload_to='constructionSite/drinkingWater_photographs/', null=True, blank=True)
    drinkingWaterRemarks=models.TextField(max_length=255, null=True, blank=True)

    isToilet=models.BooleanField(max_length=255, blank=True, null=True)
    toiletCondition=models.CharField(max_length=255, blank=True, null=True)
    toiletPhotograph=models.ImageField(upload_to='constructionSite/toilet_photographs/', blank=True, null=True)
    toiletRemarks=models.TextField(max_length=255, null=True, blank=True)

    isbarricading=models.BooleanField(blank=True, null=True)
    barricadingCondition=models.CharField(max_length=255, blank=True, null=True)
    barricadingPhotograph=models.ImageField(upload_to='constructionSite/barricading_photograph/', blank=True, null=True)
    barricadingRemarks=models.TextField(max_length=255, blank=True, null=True)


    genralphotographs=models.ImageField(upload_to='constructionSite/genral_photograph/', blank=True, null=True)
    documents=models.FileField(upload_to='constructionSite/documents/', blank=True, null=True)
    remarks=models.TextField(max_length=255, blank=True, null=True)
