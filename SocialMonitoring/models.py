...
class Rehabilitation(Baseclass):
    ...
    user = models.ForeignKey(
        User, related_name='rehabilitationUser', on_delete=models.CASCADE, blank=True)
    location = models.PointField(null=True, blank=True)
    ...
    typeOfCompensation = models.CharField(
        max_length=255, null=True, blank=True)
    otherCompensationType = models.CharField(
        max_length=255, null=True, blank=True)
    ...
    isRelocationAllowance = models.CharField(
        max_length=255, blank=True, null=True)
    RelocationAllowanceAmount = models.PositiveIntegerField(
        blank=True, null=True)
...
class LabourCamp(Baseclass):
    ...
    photographs = models.ImageField(
        upload_to='Labour Camp/GenralPhotographs/', blank=True, null=True)
    documents = models.FileField(
        upload_to='labourcamp_documents/', blank=True, null=True)
    remarks = models.TextField(max_length=255, blank=True, null=True)
